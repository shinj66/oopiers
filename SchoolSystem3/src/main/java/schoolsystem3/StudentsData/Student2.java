...
import javax.swing.*;
import schoolsystem3.StudentInsideData.Attendance.Student2Attendance;
import schoolsystem3.StudentInsideData.Grades.Student2Grades;
...
public class Student2 extends JFrame implements ActionListener {
    ...
    public Student2() {
        ...
        lblName = new JLabel("Name: Thomas Alonde");
        lblName.setBounds(20, 20, 350, 25);
        lblName.setFont(new Font("Arial", Font.PLAIN, 16));

        pnlPersonal.add(lblName);

        lblBirthdate = new JLabel("Birthdate: Nov 21, 2005");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnGrades) {
            ...
            new Student2Grades().setVisible(true);
        }
