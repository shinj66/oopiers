...
import javax.swing.*;
import schoolsystem3.StudentInsideData.Attendance.Student3Attendance;
import schoolsystem3.StudentInsideData.Grades.Student3Grades;
...
public class Student3 extends JFrame implements ActionListener {
    ...
    public Student3() {
        ...
        lblName = new JLabel("Name: Edward Ayson");
        lblName.setBounds(20, 20, 350, 25);
        lblName.setFont(new Font("Arial", Font.PLAIN, 16));

        pnlPersonal.add(lblName);

        lblBirthdate = new JLabel("Birthdate: Nov 22, 2005");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnAttendance) {
            ...
            new Student3Attendance().setVisible(true);
        }
